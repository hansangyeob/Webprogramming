...
<head>
    ...
    <link id='stylecss' type="text/css" rel="stylesheet" href="../a3/a3.css">
...
-->
            ...
            <form action="https://titan.csit.rmit.edu.au/~e54061/wp/lunardo-formtest.php" method="post" target="_blank">
                <div class="bookinng_form">
                    ...
                    <div class="personal_infor">
                        ...
                        <input onblur = "protect()" type="text" id="name" name="cust[name]" pattern="^[a-zA-Z \-.']{1,100}$">
                        <br><br>

                        <!-- Email-->
                        <label for="email">Email:</label>
                        <input onblur = "protect()" type="email" id="email" name="cust[email]">
                        <br><br>
                        ...
                        <input onblur = "protect()" type="text" id="Credit_Card" name="cust[card]" pattern="\d{14,19 }">
                        <br><br>
  ...
  print '</pre>';
    ...
    <script defer src="../a3/script.js"></script>
</body>
